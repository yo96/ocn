...
from net.BadMeshRouterRTL import BadMeshRouterRTL
...
def test( test_params, dump_vcd, test_verilog ):
  nrouters = 6
  run_router_test( BadMeshRouterRTL(num_routers = nrouters), test_params.routerid, 0, 2,
...
def test_hypothesis_square( nrouter_log2,router_id,
  ...
  run_router_test( BadMeshRouterRTL(num_routers=nrouter), 
                   router_id, row_min, row_max,
                   src_delay, sink_delay,
