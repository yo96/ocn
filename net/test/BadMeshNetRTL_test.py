...
def test_mesh_hypothesis(mesh_wid, mesh_ht, src_delay, sink_delay,
  ...
  hypothesis.event( "Number of routers: %d Number of packets: %d\n" % (mesh_ht*mesh_wid, len(msgs) ) )

  run_net_test( BadMeshNetRTL( num_routers = nrouters, 
